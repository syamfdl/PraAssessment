...
import org.d3if0086.myapplication.databinding.FragmentFirstBinding
...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<FragmentFirstBinding>(inflater, R.layout.fragment_first,
            container, false)
